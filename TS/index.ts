let userName: string  = 'jisu';
// userName=123;
// userName='123';
let userAge =32;
let userNameTotal  : string[] = [];
userNameTotal.push('kim');
userNameTotal.push('park');
// userNameTotal.push(123);
console.log("gg",userNameTotal)
let userInfo : [{name ?  : String , age : number }] = [{name : 'kim' , age :32}]
userInfo.push({age: 99})

console.log(userInfo)
type MyType = string | number;

var whatType : MyType = 123;

//x는 받는 인자 타입    , : 뒤에는 리턴 타입    
function fnfnfn(x : string) :   number {
...
let myFavoriteSinger : { name : String , title : String} ={ name:'aa' , title : 'bb'}
