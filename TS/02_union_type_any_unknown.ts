...
let age2: (string | number) = 100;
var arr2: (number | string)[] = [1,'2',3]
...
let unknown2 : unknown = 10;
let unknown22 : unknown = 'Test';

//console.log(unknown2.length); // 문제 발생
//console.log(unknown22.length); // 문제 발생 
let unknown222: unknown = 10;
let unknown2222: unknown = "unknown";
